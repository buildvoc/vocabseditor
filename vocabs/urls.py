...
urlpatterns = [
    ...
    url(r'^concepts/get_from_labels/$', views.get_skosconcepts_from_labels, name='get_concepts_from_labels'),
    url(r'^concepts/mark_as_trained/$', views.mark_skosconcepts_as_trained, name='get_concepts_from_labels'),
